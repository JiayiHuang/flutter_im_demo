...
List<ContactVO> contactData = [
  ...
  new ContactVO(
      ...
      avatarUrl:
      ''),
  new ContactVO(sectionKey: 'L', name: '联通', avatarUrl: ''),
  new ContactVO(
      sectionKey: 'L',
      name: '留学生',
  ...
  new ContactVO(
      ...
      avatarUrl:
      ''),
  new ContactVO(sectionKey: 'M', name: 'Mary', avatarUrl: ''),
  new ContactVO(
      sectionKey: 'M',
      name: 'Master',
      avatarUrl:
      ''),
  new ContactVO(sectionKey: 'P', name: '彭于晏', avatarUrl: ''),
  new ContactVO(
      sectionKey: 'P',
      name: '彭简',
      avatarUrl:
  ...
  new ContactVO(sectionKey: 'S', name: '孙丽', avatarUrl: ''),
  new ContactVO(
      sectionKey: 'S',
      name: '沈家',
      avatarUrl:
  ...
  new ContactVO(sectionKey: 'X', name: '小猪', avatarUrl: ''),
  new ContactVO(
      sectionKey: 'X',
      name: '小猪佩奇',
      avatarUrl:
